...
var cache1 = cacheFunction(sumaConDos);
console.log(cache1(4));
console.log(cache1(4));
console.log(cache1(8));
console.log(cache1(6));
...
// el primer valor dado en el bind es el destino que queremos que tenga el this en caso de que se desee redireccionar.
// el parametro inicial del argumento seria el reservado para especificar el redireccionamiento del this, o en su defecto se asignaria null o "" para que sea omitido.
// el orden de las variables dadas a continuacion del this es el mismo que se le asignarian a las variables de la funcion bindeada.
